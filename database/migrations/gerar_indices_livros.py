...
def up(db):
    try:
        ...
        colecao.create_index([('titulo',1),('autor',-1)])
...
def down(db):
    try:
        ...
        colecao.drop_index("_id_1") #o mongo cria o _1 para refereir ao ordem.
        colecao.drop_index("titulo_1") #sendo 1 crescente ou -1 decrescente)
        colecao.drop_index("autor_1")        
        colecao.drop_index("editora_1")
        colecao.drop_index("data_criacao")
